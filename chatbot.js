...
(function() {
  ...
  function injectStyles() {
    ...
    style.textContent =
      ...
      '.ic-chat-fab{width:64px;height:64px;border-radius:50%;background:#1a1a1a;cursor:pointer;display:flex;align-items:center;justify-content:center;box-shadow:0 4px 20px rgba(0,0,0,.3);transition:transform .3s,box-shadow .3s;position:relative;border:3px solid #E8831A}' +
