...
function renderMachineCard(m) {
  ...
  return `<div class="machine-card" id="${m.id}" data-fuel="${m.fuel}" data-steering="${m.steering}" data-power="${m.powerKw}" data-speed="${m.speedKmh}" data-pushpull="${m.pushPullKg}" data-breakout="${m.breakoutKg}" data-branches="${m.branches.join(',')}">
    ...
    <div class="machine-body">
      ...
      <div class="m-actions"><a href="https://myironcub.store" class="btn btn-cta btn-sm" target="_blank">Kopen</a><a href="afspraak.html" class="btn btn-outline-dark btn-sm">Huren</a><a href="lease.html" class="btn btn-outline-dark btn-sm">Leasen</a><a href="demodagen.html" class="btn btn-outline-dark btn-sm">Demo</a></div>
